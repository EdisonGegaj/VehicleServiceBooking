...
public class InvoicesApiController : ControllerBase
{
    ...
    public async Task<ActionResult<Invoice>> CreateInvoice([FromBody] CreateInvoiceDto dto)
    {
        ...
        // Kontrollo nëse WorkOrder është gati për invoice
        ...
        // Kontrollo nëse ekziston tashmë invoice për këtë WorkOrder
        ...
        var invoice = new Invoice
        {
            ...
            DueDate = DateTime.UtcNow.AddDays(30), // 30 ditë për pagesë
